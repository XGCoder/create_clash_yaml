# Clash Configurator Pro

一个强大、美观、易用的 Clash 配置文件生成工具，采用现代化UI设计，支持多种订阅格式，可自动解析和合并多个节点来源。

[![Language](https://img.shields.io/badge/Language-Python-blue.svg)](https://www.python.org/)
[![License](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![Version](https://img.shields.io/badge/Version-0.2.0-orange.svg)](https://github.com/XGCoder/Config_Merge_Shunt)

## 📑 目录

- [Clash Configurator Pro](#clash-configurator-pro)
  - [📑 目录](#-目录)
  - [✨ 主要特性](#-主要特性)
  - [🔧 安装方法](#-安装方法)
  - [📖 使用指南](#-使用指南)
...
全新的 `Clash Configurator Pro` 采用单页三栏式布局，为您提供从左到右的引导式工作流。
...
**Q: 为什么“使用高级规则集”需要 `local_config_25-03-03.yaml` 文件？**  
...
- **0.2.0** (当前版本)
  - ✅ 修复端口映射核心BUG：
    - 修复端口冲突无限循环问题（删除不必要的 `st.rerun()` 调用）
    - 修复端口验证不生效问题（验证前先同步所有端口输入值）
    - 新增「确认端口映射」复选框，统一验证流程
    - 优化端口冲突提示逻辑，未确认时显示引导提示
  - ✅ UI优化：
    - 移除界面中的序号标记（①②③），简化视觉设计
    - 移除重复的图标显示（icon参数）
    - 配置文件名增加时分信息（格式：config_20251013_0951.yaml）
    - 强制使用东八区（北京时间）生成文件名
  - 🎯 用户体验提升：
    - 端口修改时自动取消确认状态，避免误操作
    - 端口冲突时显示详细的节点信息
